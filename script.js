...
const RECITERS = [
  { id:"abdul_basit", name:"عبدالباسط (مجود)", base:"https://download.quranicaudio.com/quran/abdul_basit/mujawwad/", ext:".mp3" },
  ...
  { id:"ajmny", name:"العجمي", base:"https://download.quranicaudio.com/quran/ahmed_ibn_ali_al_ajamy/", ext:".mp3" },
  { id:"maher", name:"ماهر المعيقلي", base:"https://download.quranicaudio.com/quran/maher_al_muaiqly/", ext:".mp3" },
  { id:"sudais", name:"السديس", base:"https://download.quranicaudio.com/quran/abdulrahman_al_sudais/", ext:".mp3" },
];

const AI_SITES = [
  {name:"ChatGPT", url:"https://chat.openai.com", desc:"محادثة وتوليد نصوص متعددة اللغات.", featured:true},
  {name:"Gemini", url:"https://gemini.google.com", desc:"مساعد جوجل متعدد الوسائط (نص، صور، كود).", featured:true},
  ...
  {name:"Phind", url:"https://www.phind.com", desc:"بحث للمبرمجين مع إجابات دقيقة وسريعة."},
  {name:"Copy.ai", url:"https://www.copy.ai", desc:"توليد نصوص تسويقية ومنشورات."},
  {name:"Jasper AI", url:"https://www.jasper.ai", desc:"محتوى تسويقي محترف للشركات."},
  ...
  {name:"HeyGen", url:"https://www.heygen.com", desc:"صنع أفاتار فيديو بصوتك ولغتك."},
  {name:"ElevenLabs", url:"https://elevenlabs.io", desc:"تحويل نص إلى صوت واقعي بعدة لهجات."},
  {name:"Suno", url:"https://suno.ai", desc:"توليد موسيقى وأغاني كاملة من نص."},
...
const ENGLISH = {
  ...
  write: [
    ...
    {name:"QuillBot", url:"https://quillbot.com", desc:"إعادة صياغة ومفردات (استخدمه بحذر)."},
...
const WEB3FORMS_KEY = ""; // optional key
